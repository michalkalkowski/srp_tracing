...
# !!! Reassigning single orientation to all cells
orientations = np.zeros(orientations.shape)
orientations[new_wm == 1] = np.deg2rad(-30)
...
target = np.load('../data/SRP_validation_backwall_anisotropic.npy')
